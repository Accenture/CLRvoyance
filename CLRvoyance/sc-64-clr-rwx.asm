...
INDEX_OLEAUT32_SAFEARRAYGETLBOUND       equ 7 * POINTERSIZE + STACKSPACE
INDEX_OLEAUT32_SAFEARRAYGETUBOUND       equ 8 * POINTERSIZE + STACKSPACE
...
segment .text
	...
	LOOKUP_API_RWX KERNEL32DLL, KERNEL32_LOADLIBRARYA, INDEX_KERNEL32_LOADLIBRARYA
	...
	LOOKUP_API_RWX MSCOREEDLL, MSCOREE_CLRCREATEINSTANCE, INDEX_MSCOREE_CLRCREATEINSTANCE
	...
	LOOKUP_API_RWX OLEAUT32DLL, OLEAUT32_SAFEARRAYCREATE, INDEX_OLEAUT32_SAFEARRAYCREATE
	LOOKUP_API_RWX OLEAUT32DLL, OLEAUT32_SAFEARRAYCREATEVECTOR, INDEX_OLEAUT32_SAFEARRAYCREATEVECTOR
	LOOKUP_API_RWX OLEAUT32DLL, OLEAUT32_SAFEARRAYACCESSDATA, INDEX_OLEAUT32_SAFEARRAYACCESSDATA
	LOOKUP_API_RWX OLEAUT32DLL, OLEAUT32_SAFEARRAYUNACCESSDATA, INDEX_OLEAUT32_SAFEARRAYUNACCESSDATA
	LOOKUP_API_RWX OLEAUT32DLL, OLEAUT32_VARIANTINIT, INDEX_OLEAUT32_VARIANTINIT
	LOOKUP_API_RWX OLEAUT32DLL, OLEAUT32_SAFEARRAYGETLBOUND, INDEX_OLEAUT32_SAFEARRAYGETLBOUND
	LOOKUP_API_RWX OLEAUT32DLL, OLEAUT32_SAFEARRAYGETUBOUND, INDEX_OLEAUT32_SAFEARRAYGETUBOUND
	...
	lea r8, [rel LLOWER]
	mov rdx, 1
	mov rcx, [rel METHODPARAM]
	call [rsp + INDEX_OLEAUT32_SAFEARRAYGETLBOUND]
	test eax, eax
	jnz done
	...
	mov rdx, 1
	mov rcx, [rel METHODPARAM]
	call [rsp + INDEX_OLEAUT32_SAFEARRAYGETUBOUND]
	test eax, eax
	jnz done
...
METHODPARAM     dq 0x0000000000000000
LLOWER 			dq 0x0000000000000000
LUPPER 			dq 0x0000000000000000
...
OLEAUT32_SAFEARRAYGETLBOUND     db "SafeArrayGetLBound", 0
OLEAUT32_SAFEARRAYGETUBOUND     db "SafeArrayGetUBound", 0
