...
KERNEL32_NUMBER_OF_FUNCTIONS	equ 5
...
NTDLL_NUMBER_OF_FUNCTIONS 	     	  equ 1
...
KERNEL32_CREATETHREAD 	  dd 0x00000000
...
NTDLL_FUNCTIONS_TABLE:
NTDLL_NTCONTINUE 				  dd 0x00000000
